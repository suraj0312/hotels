...
def main(host, port):
    try:
        ...
        skill = AgentSkill(
                    id="hilton_hotel_booking_assistant",
                    name="Hilton Hotel Booking Assistant",
                    description=(
                        "Helps users search Hilton hotels, add hotel stays to a booking cart, "
                    ...
                    examples=[
                        "Find Hilton hotels for 2 guests",
                        "Show Hilton hotels near Times Square under INR250/night",
                        "Add the Hilton Midtown to my booking with 2 rooms",
                        "Change my booking to 1 room",
                        "Remove the Hilton Garden Inn from my booking",
                        "Apply promo code HILTON10",
        ...
        agent_card = AgentCard(
            name="Hilton Hotels Booking Agent",
            description=(
                "A Hilton-only hotel search and booking agent. "
                "Use this agent when the user wants Hilton properties specifically, "
                "or when the orchestrator is routing Hilton inventory requests."
            ),
            url=base_url,  # keep same
            version="1.0.0",
